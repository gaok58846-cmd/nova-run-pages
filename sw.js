const BUILD='2026-07-29-mobile-polish32';
const CACHE=`nova-run-${BUILD}`;
const CORE=[
  './','./index.html','./styles.css?v=20260729-settings-layer31','./config.js?v=20260723-mobile-pwa12','./i18n.js?v=20260723-mobile-pwa12','./storage.js?v=20260723-mobile-pwa12','./platform.js?v=20260723-mobile-pwa12','./audio.js?v=20260722-premium7','./select-menu.js?v=20260723-mobile-pwa12','./ui.js?v=20260729-mobile-polish32','./player.js?v=20260729-mobile-polish32','./backgrounds.js?v=20260723-mobile-pwa12','./state-effects.js?v=20260723-mobile-pwa12','./challenge-engine.js?v=20260722-premium2','./mountain-map.js?v=20260722-premium2','./tide-city-map.js?v=20260722-premium2','./sand-clock-map.js?v=20260722-premium2','./game.js?v=20260723-mobile-pwa12','./manifest.webmanifest','./assets/nova-cover.webp?v=20260721','./assets/nova-cover-mobile.webp?v=20260721','./assets/scene-previews/guangzhou.webp','./assets/scene-previews/shanghai.webp','./assets/scene-previews/shenzhen.webp','./assets/scene-previews/snow.webp','./assets/scene-previews/volcano.webp','./assets/scene-previews/jiuzhaigou.webp','./assets/scene-previews/dream-peak.webp','./assets/scene-previews/tide-city.webp','./assets/scene-previews/sand-clock.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/icon-maskable-512.png','./assets/icons/apple-touch-icon.png'
];
